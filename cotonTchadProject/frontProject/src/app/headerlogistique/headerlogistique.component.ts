...
@Component({
  selector: 'app-headerlogistique',
  templateUrl: './headerlogistique.component.html',
  styleUrls: ['./headerlogistique.component.css']
})
export class HeaderlogistiqueComponent implements OnInit {
