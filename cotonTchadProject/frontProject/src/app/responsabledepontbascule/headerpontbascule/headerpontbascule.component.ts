...
@Component({
  selector: 'app-headerpontbascule',
  templateUrl: './headerpontbascule.component.html',
  styleUrls: ['./headerpontbascule.component.css']
})
export class HeaderpontbasculeComponent implements OnInit {
